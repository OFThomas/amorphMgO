...
class data:
  ...
  # --------------------------------------------------------------------
  # return list of atoms and bonds to viz for data file

  def viz(self,i):
    if i: raise StandardError, "cannot call data.viz() except for time = 0"
...
skeywords = [["Masses","atom types"],["Atoms","atoms"],["Bonds","bonds"],
